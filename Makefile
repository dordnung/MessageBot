...
INCLUDE += -I. -I.. -Isdk -I3rdparty -I3rdparty/json -I$(SMSDK)/public -I$(SMSDK)/public/amtl -I$(SMSDK)/public/amtl/amtl -I$(SMSDK)/sourcepawn/include -I$(SMSDK)/core -I$(CURL)/include
